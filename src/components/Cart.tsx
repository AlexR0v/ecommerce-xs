    ...
    >
      <div className='cart-container'>
        ...
        <div className='product-container'>
          {cartItems && cartItems.length >= 1 && cartItems.map((item) => (
            <div
              className='product'
              key={item._id}
            >
              ...
              <div className='item-desc'>
                ...
                <div className='flex bottom'>
                  <div>
                    ...
                    <span
                      className='minus'
                      onClick={() => toggleCartItemQuanitity ? toggleCartItemQuanitity(item._id, 'dec') : null}
                    >
                    <AiOutlineMinus />
                    </span>
                      <span
                      ...
                      <span
                        className='plus'
                        onClick={() => toggleCartItemQuanitity ? toggleCartItemQuanitity(item._id, 'inc') : null}
                      ><AiOutlinePlus /></span>
                    </p>
                  </div>
                  <button
